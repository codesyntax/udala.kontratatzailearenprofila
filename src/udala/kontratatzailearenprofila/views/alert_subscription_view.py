...
class IAlertSubscriptionView(Interface):
    """Marker Interface for IAlertSubscriptionView"""


@implementer(IAlertSubscriptionView)
class AlertSubscriptionView(BrowserView):
