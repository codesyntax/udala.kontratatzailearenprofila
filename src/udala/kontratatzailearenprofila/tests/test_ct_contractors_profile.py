# -*- coding: utf-8 -*-
from udala.kontratatzailearenprofila.content.contractors_profile import IContractorsProfile  # NOQA E501
from udala.kontratatzailearenprofila.testing import UDALA_KONTRATATZAILEARENPROFILA_INTEGRATION_TESTING  # noqa
...
class ContractorsProfileIntegrationTest(unittest.TestCase):
    ...
    def test_ct_contractors_profile_factory(self):
        ...
        self.assertTrue(
            ...
            u'IContractorsProfile not provided by {0}!'.format(
                obj,
            ),
        )
