...
// Basado en "Content Syndication with Case-Hardened JavaScript" (http://kentbrewster.com/case-hardened-javascript/) [http://kentbrewster.com/rights-and-permissions]
 ...
 (function() {
	...
	function pintarTablaDinamica (r,window, literales, agrupacionPestanas) {
		...
		imagen.src = '++plone++udala.kontratatzailearenprofila/widgetPerfilContratante/w32-logo_contratacion.jpg';
	 ...
	 function mostrarLoader() {
		 $("#loading-overlay").append("<img src='++plone++udala.kontratatzailearenprofila/widgetPerfilContratante/images/loader.gif' class='loader_img'/>")
