...
(function () {
  ...
  var urlAgrupacion =
    "ac70cPublicidadWar/serviciosWidgetREST/recuperarConfiguracion/?";
  var urlAplicacion =
    "ac70cPublicidadWar/serviciosWidgetREST/recuperarContratos/?";
  ...
  $.ajax({
    ...
    success: function (html, status, xhr) {
      ...
      //Agrupacion Por tipo de contrato
        ...
        document.getElementById("agruTipoContrato").style.visibility =
          "visible";
      }
    },
...
function pintarTabla(r, window, literales) {
  ...
  if (lista == null || (lista != null && lista.length == 0)) {
    ...
    for (var i = 0; i < lista.length; i++) {
      ...
      for (var v = 0; v < valores.length; v++) {
        ...
        if (tipo == "F") {
          ...
          var fechadato = "";
          if (idioma == "es") {
            fechadato = formatearFecha_es(
              valores[v].valor.substring(0, valores[v].valor.indexOf("00"))
            );
          } else {
            fechadato = formatearFecha_eu(
              valores[v].valor.substring(0, valores[v].valor.indexOf("00"))
            );
          }
    ...
    if (idioma == "es") {
      numMaxRegistros =
        "* El n\u00famero de resultados est\u00E1 limitado a " +
        r.numMaxRegistros +
        " elementos";
    } else {
      numMaxRegistros =
        "* Emaitz kopurua " + r.numMaxRegistros + " elementuetara mugatua dago";
    }
  }
  ...
  imagen.src =
    "++plone++udala.kontratatzailearenprofila/widgetContratos/w32-logo_contratacion.jpg";
  ...
  if (document.getElementById("numResult").value == "0") {
    if (idioma == "es") {
      ...
      $("#tablaWidget").dataTable({
        ...
        oLanguage: {
          sInfo:
            "Erregistroak erakusten _START_-tik _END_-ra  _TOTAL_ erregistroko guztizkotik",
          sInfoThousands: ",",
          oPaginate: {
            sFirst: "Lehenengoa",
            sLast: "Azkena",
